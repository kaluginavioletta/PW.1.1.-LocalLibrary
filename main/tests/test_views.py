...
from LocalLibrary.main.models import Author
...
from LocalLibrary.main.models import BookInstance, Book, Genre, Language
...
class LoanedBookInstancesByUserListViewTest(TestCase):
    ...
    def test_redirect_if_not_logged_in(self):
        ...
        self.assertRedirects(
            response, '/accounts/login/?next=/main/mybooks/')
    ...
    def test_logged_in_uses_correct_template(self):
        ...
        self.assertTemplateUsed(
            response, 'main/bookinstance_list_borrowed_user.html')
...
class AuthorCreateViewTest(TestCase):
    ...
    def test_uses_correct_template(self):
        ...
        response = self.client.get(reverse('author-create'))
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'main/author_form.html')
    ...
    def test_redirects_to_detail_view_on_success(self):
        ...
        self.assertEqual(response.status_code, 302)
        self.assertTrue(response.url.startswith('/main/author/'))